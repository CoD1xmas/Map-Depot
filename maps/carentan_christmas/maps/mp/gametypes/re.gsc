...
Callback_StartGameType()
{
	...
	if(!isdefined(game["gamestarted"]))
	{
		...
		// Christmas Stern
		precacheString(&"CARENTAN_CHRISTMAS_STERN1");
		precacheString(&"CARENTAN_CHRISTMAS_STERN2");
		precacheString(&"CARENTAN_CHRISTMAS_STERN3");
		precacheString(&"CARENTAN_CHRISTMAS_STERN4");
